...
This will load the everforest plugin and apply the defaults.
...
set -g @everforest_flavor 'dark_soft'
...
`run ~/.config/tmux/plugins/everforest/tmux/everforest.tmux`, so if you try
